...
## [Nyx](https://github.com/jonathon-chew/Nyx) :star: 1
This is a simple Go script that fetches NASA's Astronomy Picture of the Day (APOD) and downloads it to your local machine.

## [Ogma](https://github.com/jonathon-chew/Ogma) :star: 1
Quick way to find number of files, lines for all sorts of different programming files and file types

## [Pantheon](https://github.com/jonathon-chew/Pantheon) :star: 1
A repository which is an index to all my others

## [Rat](https://github.com/jonathon-chew/Rat) :star: 1
Colourful cat in go
